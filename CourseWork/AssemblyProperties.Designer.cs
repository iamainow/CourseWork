...
{
	partial class _assembly_properties
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this._draughts=new System.Windows.Forms.ListBox();
			...
			this._auto_diff=new System.Windows.Forms.Button();
			...
			// _draughts
			// 
			this._draughts.FormattingEnabled=true;
			this._draughts.ItemHeight=14;
			this._draughts.Location=new System.Drawing.Point(16,99);
			this._draughts.Name="_draughts";
			this._draughts.Size=new System.Drawing.Size(289,102);
			this._draughts.TabIndex=3;
			// 
			// _add_draughts
			// 
			this._add_draughts.Location=new System.Drawing.Point(311,99);
			...
			this._add_draughts.Click+=new System.EventHandler(this._add_draughts_Click);
			// 
			// _remove_draughts
			// 
			this._remove_draughts.Location=new System.Drawing.Point(311,135);
			...
			this._remove_draughts.Click+=new System.EventHandler(this._remove_draughts_Click);
			// 
			// __name
			// 
			this.@__name.BackColor=System.Drawing.Color.Transparent;
			this.@__name.Font=new System.Drawing.Font("Arial",8.25F,System.Drawing.FontStyle.Regular,System.Drawing.GraphicsUnit.Point,((byte)(204)));
			...
			this.@__diff.Font=new System.Drawing.Font("Arial",8.25F,System.Drawing.FontStyle.Regular,System.Drawing.GraphicsUnit.Point,((byte)(204)));
			...
			// _auto_diff
			// 
			this._auto_diff.Location=new System.Drawing.Point(141,71);
			this._auto_diff.Name="_auto_diff";
			this._auto_diff.Size=new System.Drawing.Size(73,20);
			this._auto_diff.TabIndex=2;
			this._auto_diff.Text="Auto";
			this._auto_diff.UseVisualStyleBackColor=true;
			this._auto_diff.Click+=new System.EventHandler(this._auto_diff_Click);
			// 
			// _diff
			// 
			...
			// _close
			// 
			this._close.Location=new System.Drawing.Point(16,206);
			...
			this.@__id.Font=new System.Drawing.Font("Arial",8.25F,System.Drawing.FontStyle.Regular,System.Drawing.GraphicsUnit.Point,((byte)(204)));
			...
			this._id.Font=new System.Drawing.Font("Arial",8.25F,System.Drawing.FontStyle.Regular,System.Drawing.GraphicsUnit.Point,((byte)(204)));
			...
			// 
			this._draughts_properties.Location=new System.Drawing.Point(311,171);
			...
			this.Controls.Add(this._auto_diff);
			...
			this.Controls.Add(this._draughts);
			this.Controls.Add(this._name);
			this.DoubleBuffered=true;
			this.Font=new System.Drawing.Font("Arial",8.25F,System.Drawing.FontStyle.Regular,System.Drawing.GraphicsUnit.Point,((byte)(204)));
			this.FormBorderStyle=System.Windows.Forms.FormBorderStyle.FixedToolWindow;
			this.Name="_assembly_properties";
		...
		private System.Windows.Forms.ListBox _draughts;
		...
		private System.Windows.Forms.Button _auto_diff;
