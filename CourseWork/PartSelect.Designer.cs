namespace CourseWork
{
	partial class _part_select
	{
		...
		private void InitializeComponent()
		{
			...
			this._table_diff=new System.Windows.Forms.DataGridViewTextBoxColumn();
			this._table_new=new System.Windows.Forms.DataGridViewTextBoxColumn();
			this._table_done=new System.Windows.Forms.DataGridViewCheckBoxColumn();
			...
			this._tab_diff=new System.Windows.Forms.TabPage();
			this._diff_reg_ex=new System.Windows.Forms.TextBox();
			this._diff_enable=new System.Windows.Forms.CheckBox();
			this._tab_new=new System.Windows.Forms.TabPage();
			this._new_reg_ex=new System.Windows.Forms.TextBox();
			this._new_enable=new System.Windows.Forms.CheckBox();
			...
			this._tab_diff.SuspendLayout();
			this._tab_new.SuspendLayout();
			this.SuspendLayout();
			// 
			// _table
			// 
			...
			this._table.Size=new System.Drawing.Size(424,216);
			...
			this._table_name.Width=150;
			// 
			// _table_diff
			// 
			this._table_diff.HeaderText="Difficulty";
			this._table_diff.MaxInputLength=10;
			this._table_diff.Name="_table_diff";
			this._table_diff.ReadOnly=true;
			this._table_diff.Width=75;
			// 
			// _table_new
			// 
			this._table_new.HeaderText="New";
			this._table_new.MaxInputLength=10;
			this._table_new.Name="_table_new";
			this._table_new.ReadOnly=true;
			this._table_new.Width=75;
			// 
			// _table_done
			// 
			this._table_done.HeaderText="Done";
			this._table_done.Name="_table_done";
			this._table_done.ReadOnly=true;
			this._table_done.Resizable=System.Windows.Forms.DataGridViewTriState.False;
			this._table_done.Width=50;
			// 
			// __count
			// 
			this.@__count.BackColor=System.Drawing.Color.Transparent;
			this.@__count.Location=new System.Drawing.Point(350,234);
			...
			this._count.Location=new System.Drawing.Point(421,234);
			this._count.Name="_count";
			this._count.Size=new System.Drawing.Size(113,25);
			...
			this._tab.Controls.Add(this._tab_diff);
			this._tab.Controls.Add(this._tab_new);
			...
			this._tab.Size=new System.Drawing.Size(184,92);
			...
			this._tab_id.Size=new System.Drawing.Size(176,65);
			...
			this._id_reg_ex.Size=new System.Drawing.Size(164,22);
			...
			this._id_enable.Size=new System.Drawing.Size(164,22);
			...
			this._tab_name.Size=new System.Drawing.Size(176,65);
			...
			this._name_reg_ex.Size=new System.Drawing.Size(164,22);
			...
			this._name_enable.Size=new System.Drawing.Size(164,22);
			...
			// _tab_diff
			// 
			this._tab_diff.Controls.Add(this._diff_reg_ex);
			this._tab_diff.Controls.Add(this._diff_enable);
			this._tab_diff.Location=new System.Drawing.Point(4,23);
			this._tab_diff.Name="_tab_diff";
			this._tab_diff.Padding=new System.Windows.Forms.Padding(3);
			this._tab_diff.Size=new System.Drawing.Size(176,65);
			this._tab_diff.TabIndex=2;
			this._tab_diff.Text="Difficulty";
			this._tab_diff.UseVisualStyleBackColor=true;
			// 
			// _diff_reg_ex
			// 
			this._diff_reg_ex.Font=new System.Drawing.Font("Arial",9.75F,System.Drawing.FontStyle.Regular,System.Drawing.GraphicsUnit.Point,((byte)(204)));
			this._diff_reg_ex.Location=new System.Drawing.Point(6,34);
			this._diff_reg_ex.MaxLength=256;
			this._diff_reg_ex.Name="_diff_reg_ex";
			this._diff_reg_ex.Size=new System.Drawing.Size(164,22);
			this._diff_reg_ex.TabIndex=6;
			// 
			// _diff_enable
			// 
			this._diff_enable.Location=new System.Drawing.Point(6,6);
			this._diff_enable.Name="_diff_enable";
			this._diff_enable.Size=new System.Drawing.Size(164,22);
			this._diff_enable.TabIndex=1;
			this._diff_enable.Text="Enable";
			this._diff_enable.UseVisualStyleBackColor=true;
			// 
			// _tab_new
			// 
			this._tab_new.Controls.Add(this._new_reg_ex);
			this._tab_new.Controls.Add(this._new_enable);
			this._tab_new.Location=new System.Drawing.Point(4,23);
			this._tab_new.Name="_tab_new";
			this._tab_new.Padding=new System.Windows.Forms.Padding(3);
			this._tab_new.Size=new System.Drawing.Size(176,65);
			this._tab_new.TabIndex=3;
			this._tab_new.Text="New";
			this._tab_new.UseVisualStyleBackColor=true;
			// 
			// _new_reg_ex
			// 
			this._new_reg_ex.Font=new System.Drawing.Font("Arial",9.75F,System.Drawing.FontStyle.Regular,System.Drawing.GraphicsUnit.Point,((byte)(204)));
			this._new_reg_ex.Location=new System.Drawing.Point(6,34);
			this._new_reg_ex.MaxLength=256;
			this._new_reg_ex.Name="_new_reg_ex";
			this._new_reg_ex.Size=new System.Drawing.Size(164,22);
			this._new_reg_ex.TabIndex=8;
			// 
			// _new_enable
			// 
			this._new_enable.Location=new System.Drawing.Point(6,6);
			this._new_enable.Name="_new_enable";
			this._new_enable.Size=new System.Drawing.Size(164,22);
			this._new_enable.TabIndex=7;
			this._new_enable.Text="Enable";
			this._new_enable.UseVisualStyleBackColor=true;
			// 
			// __reg_ex
			// 
			this.@__reg_ex.BackColor=System.Drawing.Color.Transparent;
			this.@__reg_ex.Location=new System.Drawing.Point(47,291);
			this.@__reg_ex.Name="__reg_ex";
			this.@__reg_ex.Size=new System.Drawing.Size(111,22);
			this.@__reg_ex.TabIndex=3;
			this.@__reg_ex.Text="Regular Expression:";
			this.@__reg_ex.TextAlign=System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// __filters
			// 
			...
			this.@__filters.Size=new System.Drawing.Size(142,25);
			...
			// _filter
			// 
			this._filter.Location=new System.Drawing.Point(350,289);
			...
			this._select.Location=new System.Drawing.Point(160,332);
			...
			this._cancel.Location=new System.Drawing.Point(291,332);
			...
			// _filter_new
			// 
			this._filter_new.Location=new System.Drawing.Point(350,258);
			...
			this.Name="_part_select";
			this.ShowInTaskbar=false;
			this.StartPosition=System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text="Part Select";
			...
			this._tab_diff.ResumeLayout(false);
			this._tab_diff.PerformLayout();
			this._tab_new.ResumeLayout(false);
			this._tab_new.PerformLayout();
		...
		private System.Windows.Forms.TabPage _tab_diff;
		private System.Windows.Forms.CheckBox _diff_enable;
		...
		private System.Windows.Forms.TextBox _diff_reg_ex;
		...
		private System.Windows.Forms.TabPage _tab_new;
		private System.Windows.Forms.TextBox _new_reg_ex;
		private System.Windows.Forms.CheckBox _new_enable;
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn _table_diff;
		private System.Windows.Forms.DataGridViewTextBoxColumn _table_new;
		private System.Windows.Forms.DataGridViewCheckBoxColumn _table_done;
