namespace CourseWork
{
	partial class _draught_select
	{
		...
		private void InitializeComponent()
		{
			...
			this._table_index=new System.Windows.Forms.DataGridViewTextBoxColumn();
			this._table_name=new System.Windows.Forms.DataGridViewTextBoxColumn();
			this._table_format=new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this._tab_index=new System.Windows.Forms.TabPage();
			this._index_reg_ex=new System.Windows.Forms.TextBox();
			this._index_enable=new System.Windows.Forms.CheckBox();
			...
			this._tab_format=new System.Windows.Forms.TabPage();
			this._format_reg_ex=new System.Windows.Forms.TextBox();
			this._format_enable=new System.Windows.Forms.CheckBox();
			...
			this._tab_index.SuspendLayout();
			this._tab_name.SuspendLayout();
			this._tab_format.SuspendLayout();
			...
			this._table.Size=new System.Drawing.Size(454,216);
			...
			// _table_index
			// 
			this._table_index.HeaderText="Index";
			this._table_index.MaxInputLength=8;
			this._table_index.Name="_table_index";
			this._table_index.ReadOnly=true;
			this._table_index.Width=60;
			// 
			// _table_name
			// 
			...
			// _table_format
			// 
			this._table_format.HeaderText="Format";
			this._table_format.MaxInputLength=16;
			this._table_format.Name="_table_format";
			this._table_format.ReadOnly=true;
			this._table_format.Width=80;
			// 
			...
			this.@__count.Location=new System.Drawing.Point(427,231);
			...
			this._count.Location=new System.Drawing.Point(498,231);
			this._count.Name="_count";
			this._count.Size=new System.Drawing.Size(116,25);
			...
			this._tab.Controls.Add(this._tab_index);
			this._tab.Controls.Add(this._tab_name);
			this._tab.Controls.Add(this._tab_format);
			...
			this._tab.Size=new System.Drawing.Size(261,93);
			...
			this._tab_id.Size=new System.Drawing.Size(253,66);
			...
			this._id_reg_ex.Size=new System.Drawing.Size(241,22);
			...
			this._id_enable.Size=new System.Drawing.Size(241,22);
			...
			// _tab_index
			// 
			this._tab_index.Controls.Add(this._index_reg_ex);
			this._tab_index.Controls.Add(this._index_enable);
			this._tab_index.Location=new System.Drawing.Point(4,23);
			this._tab_index.Name="_tab_index";
			this._tab_index.Padding=new System.Windows.Forms.Padding(3);
			this._tab_index.Size=new System.Drawing.Size(253,66);
			this._tab_index.TabIndex=2;
			this._tab_index.Text="Index";
			this._tab_index.UseVisualStyleBackColor=true;
			// 
			// _index_reg_ex
			// 
			this._index_reg_ex.Font=new System.Drawing.Font("Arial",9.75F,System.Drawing.FontStyle.Regular,System.Drawing.GraphicsUnit.Point,((byte)(204)));
			this._index_reg_ex.Location=new System.Drawing.Point(6,34);
			this._index_reg_ex.MaxLength=256;
			this._index_reg_ex.Name="_index_reg_ex";
			this._index_reg_ex.Size=new System.Drawing.Size(241,22);
			this._index_reg_ex.TabIndex=6;
			// 
			// _index_enable
			// 
			this._index_enable.Location=new System.Drawing.Point(6,6);
			this._index_enable.Name="_index_enable";
			this._index_enable.Size=new System.Drawing.Size(241,22);
			this._index_enable.TabIndex=1;
			this._index_enable.Text="Enable";
			this._index_enable.UseVisualStyleBackColor=true;
			// 
			// _tab_name
			// 
			...
			this._tab_name.Size=new System.Drawing.Size(253,66);
			...
			this._name_reg_ex.Size=new System.Drawing.Size(241,22);
			...
			this._name_enable.Size=new System.Drawing.Size(241,22);
			...
			// _tab_format
			// 
			this._tab_format.Controls.Add(this._format_reg_ex);
			this._tab_format.Controls.Add(this._format_enable);
			this._tab_format.Location=new System.Drawing.Point(4,23);
			this._tab_format.Name="_tab_format";
			this._tab_format.Padding=new System.Windows.Forms.Padding(3);
			this._tab_format.Size=new System.Drawing.Size(253,66);
			this._tab_format.TabIndex=4;
			this._tab_format.Text="Format";
			this._tab_format.UseVisualStyleBackColor=true;
			// 
			// _format_reg_ex
			// 
			this._format_reg_ex.Font=new System.Drawing.Font("Arial",9.75F,System.Drawing.FontStyle.Regular,System.Drawing.GraphicsUnit.Point,((byte)(204)));
			this._format_reg_ex.Location=new System.Drawing.Point(6,34);
			this._format_reg_ex.MaxLength=256;
			this._format_reg_ex.Name="_format_reg_ex";
			this._format_reg_ex.Size=new System.Drawing.Size(241,22);
			this._format_reg_ex.TabIndex=9;
			// 
			// _format_enable
			// 
			this._format_enable.Location=new System.Drawing.Point(6,6);
			this._format_enable.Name="_format_enable";
			this._format_enable.Size=new System.Drawing.Size(241,22);
			this._format_enable.TabIndex=7;
			this._format_enable.Text="Enable";
			this._format_enable.UseVisualStyleBackColor=true;
			// 
			// _tab_rcount
			// 
			...
			this._tab_rcount.Size=new System.Drawing.Size(253,66);
			...
			this._rcount_reg_ex.Size=new System.Drawing.Size(241,22);
			...
			this._rcount_enable.Size=new System.Drawing.Size(241,22);
			...
			// _filter
			// 
			this._filter.Location=new System.Drawing.Point(427,290);
			...
			// _filter_new
			// 
			this._filter_new.Location=new System.Drawing.Point(427,259);
			...
			this.Name="_draught_select";
			this.ShowInTaskbar=false;
			this.StartPosition=System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text="Draughts Select";
			...
			this._tab_index.ResumeLayout(false);
			this._tab_index.PerformLayout();
			this._tab_name.ResumeLayout(false);
			this._tab_name.PerformLayout();
			this._tab_format.ResumeLayout(false);
			this._tab_format.PerformLayout();
		...
		private System.Windows.Forms.TabPage _tab_index;
		private System.Windows.Forms.CheckBox _index_enable;
		...
		private System.Windows.Forms.TextBox _index_reg_ex;
		...
		private System.Windows.Forms.TabPage _tab_format;
		private System.Windows.Forms.TextBox _format_reg_ex;
		private System.Windows.Forms.CheckBox _format_enable;
		private System.Windows.Forms.Button _filter_new;
		private System.Windows.Forms.DataGridViewTextBoxColumn _table_id;
		private System.Windows.Forms.DataGridViewTextBoxColumn _table_index;
		private System.Windows.Forms.DataGridViewTextBoxColumn _table_name;
		private System.Windows.Forms.DataGridViewTextBoxColumn _table_format;
